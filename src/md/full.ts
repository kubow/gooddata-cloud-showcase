/* eslint-disable */
/* THIS FILE WAS AUTO-GENERATED USING CATALOG EXPORTER; YOU SHOULD NOT EDIT THIS FILE; GENERATE TIME: 2023-09-24T22:47:04.351Z; */
 ...
 */
export const ByAllQuantityBom: IMeasure<IMeasureDefinition> = newMeasure(
    idRef("by_all_quantity_bom", "measure"),
);
/**
 * Metric Title: New
 * Metric ID: new
 * Metric Type: MAQL Metric
 */
export const New: IMeasure<IMeasureDefinition> = newMeasure(idRef("new", "measure"));
/**
 ...
 * Metric Type: MAQL Metric
 */
export const ByAllInAllOtherDimensionsQuantityBom: IMeasure<IMeasureDefinition> = newMeasure(
    idRef("by_all_in_all_other_dimensions_quantity_bom", "measure"),
);
/**
 ...
 * Metric Type: MAQL Metric
 */
export const ByQuantityBom: IMeasure<IMeasureDefinition> = newMeasure(idRef("by_quantity_bom", "measure"));
/**
 * Metric Title: COGS
 * Metric ID: cogs
 * Metric Type: MAQL Metric
 ...
 * Metric Type: MAQL Metric
 */
export const CustTest: IMeasure<IMeasureDefinition> = newMeasure(idRef("cust_test", "measure"));
/**
 ...
 * Metric Type: MAQL Metric
 */
export const Div: IMeasure<IMeasureDefinition> = newMeasure(idRef("div", "measure"));
/**
 * Metric Title: for previous
 * Metric ID: for_previous
 * Metric Type: MAQL Metric
 */
export const ForPrevious: IMeasure<IMeasureDefinition> = newMeasure(idRef("for_previous", "measure"));
/**
 * Metric Title: for previous period
 * Metric ID: for_previous_period
 * Metric Type: MAQL Metric
 */
export const ForPreviousPeriod: IMeasure<IMeasureDefinition> = newMeasure(
    idRef("for_previous_period", "measure"),
);
/**
 ...
 * Metric Type: MAQL Metric
 */
export const TotalReturnsN: IMeasure<IMeasureDefinition> = newMeasure(idRef("total_returns_n", "measure"));
/**
 ...
 * @deprecated constants generated for date attributes are deprecated in favor of DateDatasets mapping
 */
export const CustomerCreatedDateQuarterOfYear: IAttribute = newAttribute(
    "customer_created_date.quarterOfYear",
);
/**
...
export const Insights = {
    ...
    /**
     * Insight Title: X
     * Insight ID: f9680c2a-3166-440b-8c0e-dc0a52faf71b
     */ X: "f9680c2a-3166-440b-8c0e-dc0a52faf71b",
    /**
     * Insight Title: Demo
     * Insight ID: b65a3e1d-85c2-430c-8045-2515a1af102e
     */ Demo: "b65a3e1d-85c2-430c-8045-2515a1af102e",
    /**
     * Insight Title: specific_for_customer
     * Insight ID: afb49a58-dd01-401b-ab32-e6d44942355d
     */ SpecificForCustomer: "afb49a58-dd01-401b-ab32-e6d44942355d",
};
