...
export const appName = "gooddata-cloud-showcase";
...
export const backend = "https://jav.demo.cloud.gooddata.com/";
...
export const workspace = "c570b2310eb64a158e1e652e2ef4601d";
